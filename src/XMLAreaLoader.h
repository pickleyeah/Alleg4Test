...
private:
	...
	static BLOCK_T LoadBlock(tinyxml2::XMLElement *element);
	...
	static InputComponent *LoadInputComponent(tinyxml2::XMLElement *element);
	static MoveComponent *LoadMoveComponent(tinyxml2::XMLElement *element);
	static RenderComponent *LoadRenderComponent(tinyxml2::XMLElement *element);
};
